...
## News
**26th July 2019** -- PyStokes can be combined with [PyLaplace](https://github.com/rajeshrinet/pystokes/tree/master/pystokes) to compute hydrodynamic *and* phoretic interactions in autophoretic suspensions.  
