...
A detailed description of above keywords is available in the [Wiki](https://github.com/rajeshrinet/pystokes/wiki). Please read the [Wiki](https://github.com/rajeshrinet/pystokes/wiki) before you use PyStokes for your research.  
