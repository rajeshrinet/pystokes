...
def G1s3s(xij,yij,zij, b,eta):
    return np.array([[(-30*b**4*(8*xij**4 - 24*xij**2*(yij**2 + zij**2) + 3*(yij**2 + zij**2)**2) + 
      ...
      (168.*eta*PI*(xij**2 + yij**2 + zij**2)**4.5),(b**2*xij*zij*
        (-150*b**2*(4*xij**2 - 3*(yij**2 + zij**2)) + 7*(32*xij**4 + 19*xij**2*(yij**2 + zij**2) - 13*(yij**2 + zij**2)**2)))/
      (168.*eta*PI*(xij**2 + yij**2 + zij**2)**4.5),(90*b**4*(4*xij**4 + 4*yij**4 + 3*yij**2*zij**2 - zij**4 + 3*xij**2*(-9*yij**2 + zij**2)) - 
     ...
     (b**2*yij*zij*(98*xij**4 - 50*b**2*(6*xij**2 - yij**2 - zij**2) + 91*xij**2*(yij**2 + zij**2) - 7*(yij**2 + zij**2)**2))/
      ...
      (56.*eta*PI*(xij**2 + yij**2 + zij**2)**4.5),(90*b**4*(4*xij**4 + 4*yij**4 + 3*yij**2*zij**2 - zij**4 + 3*xij**2*(-9*yij**2 + zij**2)) - 
     ...
     (b**2*yij*zij*(-150*b**2*(6*xij**2 - yij**2 - zij**2) + 7*(38*xij**4 + 31*xij**2*(yij**2 + zij**2) - 7*(yij**2 + zij**2)**2)))/
      (168.*eta*PI*(xij**2 + yij**2 + zij**2)**4.5),(b**2*xij*yij*
        (150*b**2*(3*xij**2 - 4*yij**2 + 3*zij**2) - 7*(13*xij**4 - 32*yij**4 - 19*yij**2*zij**2 + 13*zij**4 + xij**2*(-19*yij**2 + 26*zij**2))))/
      (168.*eta*PI*(xij**2 + yij**2 + zij**2)**4.5),(b**2*xij*zij*
        (50*b**2*(xij**2 - 6*yij**2 + zij**2) - 7*(xij**4 - 14*yij**4 - 13*yij**2*zij**2 + zij**4 + xij**2*(-13*yij**2 + 2*zij**2))))/
      (56.*eta*PI*(xij**2 + yij**2 + zij**2)**4.5),(-30*b**4*(3*xij**4 + 8*yij**4 - 24*yij**2*zij**2 + 3*zij**4 + 6*xij**2*(-4*yij**2 + zij**2)) + 
     ...
     (b**2*yij*zij*(150*b**2*(3*xij**2 - 4*yij**2 + 3*zij**2) - 
          7*(13*xij**4 - 32*yij**4 - 19*yij**2*zij**2 + 13*zij**4 + xij**2*(-19*yij**2 + 26*zij**2))))/(168.*eta*PI*(xij**2 + yij**2 + zij**2)**4.5)]
     ,[(b**2*xij*zij*(-50*b**2*(4*xij**2 - 3*(yij**2 + zij**2)) + 7*(8*xij**4 + xij**2*(yij**2 + zij**2) - 7*(yij**2 + zij**2)**2)))/
      ...
      (168.*eta*PI*(xij**2 + yij**2 + zij**2)**4.5),(90*b**4*(4*xij**4 - yij**4 + 3*yij**2*zij**2 + 4*zij**4 + 3*xij**2*(yij**2 - 9*zij**2)) - 
     ...
     (b**2*xij*zij*(150*b**2*(xij**2 - 6*yij**2 + zij**2) - 
          7*(7*xij**4 - 38*yij**4 - 31*yij**2*zij**2 + 7*zij**4 + xij**2*(-31*yij**2 + 14*zij**2))))/(168.*eta*PI*(xij**2 + yij**2 + zij**2)**4.5),
    ...
    return np.array([[(-30*b**4*(8*xij**4 - 24*xij**2*(yij**2 + zij**2) + 3*(yij**2 + zij**2)**2) + 
     ...
     [(b**2*yij*zij*(98*xij**4 - 50*b**2*(6*xij**2 - yij**2 - zij**2) + 91*xij**2*(yij**2 + zij**2) - 7*(yij**2 + zij**2)**2))/
       ...
       (56.*eta*PI*(xij**2 + yij**2 + zij**2)**4.5),(-30*b**4*(3*xij**4 + 8*yij**4 - 24*yij**2*zij**2 + 3*zij**4 + 6*xij**2*(-4*yij**2 + zij**2)) + 
         7*b**2*(xij**6 + 16*yij**6 - 12*yij**4*zij**2 - 27*yij**2*zij**4 + zij**6 + 3*xij**4*(-9*yij**2 + zij**2) - 
            3*xij**2*(4*yij**4 + 18*yij**2*zij**2 - zij**4)))/(168.*eta*PI*(xij**2 + yij**2 + zij**2)**4.5),
      (b**2*yij*zij*(50*b**2*(3*xij**2 - 4*yij**2 + 3*zij**2) + 7*(-7*xij**4 + 8*yij**4 + yij**2*zij**2 - 7*zij**4 + xij**2*(yij**2 - 14*zij**2))))/
       (56.*eta*PI*(xij**2 + yij**2 + zij**2)**4.5)],[(b**2*xij*zij*
         (150*b**2*(xij**2 - 6*yij**2 + zij**2) - 7*(7*xij**4 - 38*yij**4 - 31*yij**2*zij**2 + 7*zij**4 + xij**2*(-31*yij**2 + 14*zij**2))))/
       (168.*eta*PI*(xij**2 + yij**2 + zij**2)**4.5),(b**2*yij*zij*
         (150*b**2*(3*xij**2 - 4*yij**2 + 3*zij**2) - 7*(13*xij**4 - 32*yij**4 - 19*yij**2*zij**2 + 13*zij**4 + xij**2*(-19*yij**2 + 26*zij**2))))/
       (168.*eta*PI*(xij**2 + yij**2 + zij**2)**4.5),(-90*b**4*(xij**4 - 4*yij**4 + 27*yij**2*zij**2 - 4*zij**4 - 3*xij**2*(yij**2 + zij**2)) + 
         7*b**2*(xij**6 - 8*yij**6 + 99*yij**4*zij**2 + 87*yij**2*zij**4 - 20*zij**6 - 6*xij**4*(yij**2 + 3*zij**2) - 
            3*xij**2*(5*yij**4 - 27*yij**2*zij**2 + 13*zij**4)))/(504.*eta*PI*(xij**2 + yij**2 + zij**2)**4.5)]])
...
def G2s3s(xij,yij,zij, b,eta):
    return np.array([[(1.6370222718023522*b**3*xij*(-0.38888888888888884*xij**6 - 0.5104166666666666*yij**6 - 1.5312499999999998*yij**4*zij**2 - 
     ...
     [(4.9110668154070565*b**3*yij*(-0.35648148148148145*xij**6 - 0.032407407407407406*yij**6 - 0.09722222222222221*yij**4*zij**2 - 
           0.09722222222222221*yij**2*zij**4 - 0.032407407407407406*zij**6 + xij**4*(0.10532407407407408*yij**2 + 0.10532407407407408*zij**2) + 
      ...
      (-4.297183463481174*b**3*xij*yij*zij*(-0.2932098765432099*xij**4 + 0.6790123456790124*yij**4 + 0.3858024691358025*yij**2*zij**2 - 
           0.2932098765432099*zij**4 + xij**2*(0.3858024691358025*yij**2 - 0.5864197530864198*zij**2) + b**2*(1.*xij**2 - 2.*yij**2 + 1.*zij**2)))/
       (eta*(xij**2 + yij**2 + zij**2)**5.5)],[(4.9110668154070565*b**3*zij*
      ...
      (-4.297183463481175*b**3*xij*yij*zij*(-0.32407407407407407*xij**4 + 0.6481481481481481*yij**4 + 0.32407407407407407*yij**2*zij**2 - 
       ...
       (eta*(xij**2 + yij**2 + zij**2)**5.5),(0.20462778397529402*b**3*xij*
         (-0.25925925925925924*xij**6 + 1.6851851851851851*yij**6 - 15.037037037037036*yij**4*zij**2 - 14.712962962962962*yij**2*zij**4 + 
           2.009259259259259*zij**6 + xij**4*(1.1666666666666667*yij**2 + 1.4907407407407407*zij**2) + 
           xij**2*(3.111111111111111*yij**4 - 13.546296296296296*yij**2*zij**2 + 3.759259259259259*zij**4) + 
           b**2*(1.*xij**4 - 6.*yij**4 + 51.*yij**2*zij**2 - 6.*zij**4 + xij**2*(-5.*yij**2 - 5.*zij**2))))/(eta*(xij**2 + yij**2 + zij**2)**5.5)],
     [(-0.8185111359011761*b**3*xij*(-0.38888888888888884*xij**6 - 1.361111111111111*yij**6 - 2.381944444444444*yij**4*zij**2 - 
           0.6805555555555555*yij**2*zij**4 + 0.34027777777777773*zij**6 + xij**4*(2.9652777777777777*yij**2 - 0.43749999999999994*zij**2) + 
      ...
      (-4.297183463481175*b**3*xij*yij*zij*(-0.32407407407407407*xij**4 + 0.6481481481481481*yij**4 + 0.32407407407407407*yij**2*zij**2 - 
       ...
       (eta*(xij**2 + yij**2 + zij**2)**5.5),(3.06941675962941*b**3*yij*
         (-0.2722222222222222*xij**6 - 0.2074074074074074*yij**6 + 0.674074074074074*yij**4*zij**2 + 0.6092592592592593*yij**2*zij**4 - 
           0.2722222222222222*zij**6 + xij**4*(0.6092592592592593*yij**2 - 0.8166666666666667*zij**2) + 
     ...
     [(8.59436692696235*b**3*xij*yij*zij*(-0.32407407407407407*xij**4 + 0.16203703703703703*yij**4 + 0.32407407407407407*yij**2*zij**2 + 
           0.16203703703703703*zij**4 + b**2*(1.*xij**2 - 0.5*yij**2 - 0.5*zij**2) + xij**2*(-0.16203703703703703*yij**2 - 0.16203703703703703*zij**2)
           ))/(eta*(xij**2 + yij**2 + zij**2)**5.5),(-1.227766703851764*b**3*zij*
         (-0.2808641975308642*xij**6 - 0.33487654320987653*yij**6 - 0.6265432098765432*yij**4*zij**2 - 0.24845679012345678*yij**2*zij**4 + 
           0.04320987654320988*zij**6 + xij**4*(2.506172839506173*yij**2 - 0.5185185185185186*zij**2) + 
      ...
      (-4.297183463481174*b**3*xij*yij*zij*(-0.2932098765432099*xij**4 + 0.6790123456790124*yij**4 + 0.3858024691358025*yij**2*zij**2 - 
       ...
       (eta*(xij**2 + yij**2 + zij**2)**5.5),(0.6138833519258821*b**3*zij*
         (-0.25925925925925924*xij**6 - 2.8518518518518516*yij**6 + 0.8425925925925926*yij**4*zij**2 + 3.435185185185185*yij**2*zij**4 - 
           ...
           xij**2*(0.8425925925925926*yij**4 + 6.87037037037037*yij**2*zij**2 - 0.7777777777777778*zij**4) + 
           b**2*(1.*xij**4 + 8.*yij**4 - 12.*yij**2*zij**2 + 1.*zij**4 + xij**2*(-12.*yij**2 + 2.*zij**2))))/(eta*(xij**2 + yij**2 + zij**2)**5.5),
      (0.6138833519258821*b**3*yij*(-0.21604938271604937*xij**6 + 0.43209876543209874*yij**6 + 1.4043209876543208*xij**4*zij**2 - 
           4.104938271604938*yij**4*zij**2 - 2.700617283950617*yij**2*zij**4 + 1.8364197530864197*zij**6 + 
...
def G3s3s(xij,yij,zij, b,eta):
    return np.array([[(-90*b**6*(16*xij**6 - 120*xij**4*(yij**2 + zij**2) + 90*xij**2*(yij**2 + zij**2)**2 - 5*(yij**2 + zij**2)**3) + 
         35*b**4*(16*xij**8 - 88*xij**6*(yij**2 + zij**2) - 38*xij**4*(yij**2 + zij**2)**2 + 63*xij**2*(yij**2 + zij**2)**3 - 3*(yij**2 + zij**2)**4))
        /(56.*eta*PI*(xij**2 + yij**2 + zij**2)**6.5),(-5*b**4*xij*yij*
      ...
      (270*b**6*(8*xij**6 - (6*yij**2 - zij**2)*(yij**2 + zij**2)**2 - 4*xij**4*(29*yij**2 + zij**2) + 
         ...
         7*b**4*(104*xij**8 + 3*xij**2*(377*yij**2 - 38*zij**2)*(yij**2 + zij**2)**2 - 3*(22*yij**2 - 3*zij**2)*(yij**2 + zij**2)**3 + 
            xij**6*(-1364*yij**2 + 76*zij**2) - xij**4*(271*yij**4 + 422*yij**2*zij**2 + 151*zij**4)))/(168.*eta*PI*(xij**2 + yij**2 + zij**2)**6.5),
      ...
      (5*b**4*xij*yij*(-34*xij**6 + xij**4*(87*yij**2 - 53*zij**2) - (34*yij**2 - 15*zij**2)*(yij**2 + zij**2)**2 + 
           xij**2*(87*yij**4 + 83*yij**2*zij**2 - 4*zij**4) + 54*b**2*(2*xij**4 + 2*yij**4 + yij**2*zij**2 - zij**4 + xij**2*(-7*yij**2 + zij**2))))/
       (8.*eta*PI*(xij**2 + yij**2 + zij**2)**6.5),(5*b**4*xij*zij*
         (-34*xij**6 + xij**4*(367*yij**2 - 53*zij**2) - 3*(44*yij**2 - 5*zij**2)*(yij**2 + zij**2)**2 + 
           xij**2*(269*yij**4 + 265*yij**2*zij**2 - 4*zij**4) + 
           54*b**2*(2*xij**4 + 8*yij**4 + 7*yij**2*zij**2 - zij**4 + xij**2*(-23*yij**2 + zij**2))))/(24.*eta*PI*(xij**2 + yij**2 + zij**2)**6.5)],
      ...
      (-270*b**6*(6*xij**6 - 8*yij**6 + 4*yij**4*zij**2 + 11*yij**2*zij**4 - zij**6 + xij**4*(-101*yij**2 + 11*zij**2) + 
       ...
       (168.*eta*PI*(xij**2 + yij**2 + zij**2)**6.5),(5*b**4*yij*zij*
         (-132*xij**6 + xij**4*(269*yij**2 - 249*zij**2) - (34*yij**2 - 15*zij**2)*(yij**2 + zij**2)**2 + 
           ...
           54*b**2*(8*xij**4 + 2*yij**4 + yij**2*zij**2 - zij**4 + xij**2*(-23*yij**2 + 7*zij**2))))/(24.*eta*PI*(xij**2 + yij**2 + zij**2)**6.5)],
     [(-5*b**4*xij*zij*(-152*xij**6 + 188*xij**4*(yij**2 + zij**2) + 265*xij**2*(yij**2 + zij**2)**2 - 75*(yij**2 + zij**2)**3 + 
           54*b**2*(8*xij**4 - 20*xij**2*(yij**2 + zij**2) + 5*(yij**2 + zij**2)**2)))/(24.*eta*PI*(xij**2 + yij**2 + zij**2)**6.5),
      (5*b**4*yij*zij*(96*xij**6 + 8*xij**4*(yij**2 + zij**2) - 83*xij**2*(yij**2 + zij**2)**2 + 5*(yij**2 + zij**2)**3 - 
           18*b**2*(16*xij**4 - 16*xij**2*(yij**2 + zij**2) + (yij**2 + zij**2)**2)))/(8.*eta*PI*(xij**2 + yij**2 + zij**2)**6.5),
      ...
      (5*b**4*xij*yij*(-34*xij**6 + 3*(5*yij**2 - 44*zij**2)*(yij**2 + zij**2)**2 + xij**4*(-53*yij**2 + 367*zij**2) + 
           ...
           54*b**2*(2*xij**4 - yij**4 + 7*yij**2*zij**2 + 8*zij**4 + xij**2*(yij**2 - 23*zij**2))))/(24.*eta*PI*(xij**2 + yij**2 + zij**2)**6.5),
      ...
      (-270*b**6*(2*xij**6 + 2*yij**6 - 15*yij**4*zij**2 - 15*yij**2*zij**4 + 2*zij**6 - 15*xij**4*(yij**2 + zij**2) - 
       ...
       (168.*eta*PI*(xij**2 + yij**2 + zij**2)**6.5)],[(270*b**6*
      ...
      (-5*b**4*xij*yij*(-75*xij**6 - 152*yij**6 + 188*yij**4*zij**2 + 265*yij**2*zij**4 - 75*zij**6 + 5*xij**4*(53*yij**2 - 45*zij**2) + 
           ...
           54*b**2*(5*xij**4 + 8*yij**4 - 20*yij**2*zij**2 + 5*zij**4 + 10*xij**2*(-2*yij**2 + zij**2))))/(24.*eta*PI*(xij**2 + yij**2 + zij**2)**6.5)
       ,(5*b**4*xij*zij*(5*xij**6 + 96*yij**6 + 8*yij**4*zij**2 - 83*yij**2*zij**4 + 5*zij**6 + xij**4*(-83*yij**2 + 15*zij**2) + 
           ...
           18*b**2*(xij**4 + 16*yij**4 - 16*yij**2*zij**2 + zij**4 + 2*xij**2*(-8*yij**2 + zij**2))))/(8.*eta*PI*(xij**2 + yij**2 + zij**2)**6.5)],
     [(5*b**4*yij*zij*(96*xij**6 + 8*xij**4*(yij**2 + zij**2) - 83*xij**2*(yij**2 + zij**2)**2 + 5*(yij**2 + zij**2)**3 - 
           18*b**2*(16*xij**4 - 16*xij**2*(yij**2 + zij**2) + (yij**2 + zij**2)**2)))/(8.*eta*PI*(xij**2 + yij**2 + zij**2)**6.5),
      ...
      (-270*b**6*(2*xij**6 + 2*yij**6 - 15*yij**4*zij**2 - 15*yij**2*zij**4 + 2*zij**6 - 15*xij**4*(yij**2 + zij**2) - 
       ...
       (168.*eta*PI*(xij**2 + yij**2 + zij**2)**6.5),(5*b**4*xij*zij*
         (5*xij**6 + 96*yij**6 + 8*yij**4*zij**2 - 83*yij**2*zij**4 + 5*zij**6 + xij**4*(-83*yij**2 + 15*zij**2) + 
           xij**2*(8*yij**4 - 166*yij**2*zij**2 + 15*zij**4) - 
           18*b**2*(xij**4 + 16*yij**4 - 16*yij**2*zij**2 + zij**4 + 2*xij**2*(-8*yij**2 + zij**2))))/(8.*eta*PI*(xij**2 + yij**2 + zij**2)**6.5),
      (5*b**4*xij*yij*(15*xij**6 - 34*yij**6 + 367*yij**4*zij**2 + 269*yij**2*zij**4 - 132*zij**6 - 2*xij**4*(2*yij**2 + 51*zij**2) + 
           xij**2*(-53*yij**4 + 265*yij**2*zij**2 - 249*zij**4) - 
           54*b**2*(xij**4 - 2*yij**4 + 23*yij**2*zij**2 - 8*zij**4 - xij**2*(yij**2 + 7*zij**2))))/(24.*eta*PI*(xij**2 + yij**2 + zij**2)**6.5)],
     [(5*b**4*xij*yij*(-34*xij**6 + xij**4*(87*yij**2 - 53*zij**2) - (34*yij**2 - 15*zij**2)*(yij**2 + zij**2)**2 + 
           xij**2*(87*yij**4 + 83*yij**2*zij**2 - 4*zij**4) + 54*b**2*(2*xij**4 + 2*yij**4 + yij**2*zij**2 - zij**4 + xij**2*(-7*yij**2 + zij**2))))/
      ...
      (-5*b**4*xij*yij*(-75*xij**6 - 152*yij**6 + 188*yij**4*zij**2 + 265*yij**2*zij**4 - 75*zij**6 + 5*xij**4*(53*yij**2 - 45*zij**2) + 
       ...
       ,(5*b**4*xij*zij*(5*xij**6 + 96*yij**6 + 8*yij**4*zij**2 - 83*yij**2*zij**4 + 5*zij**6 + xij**4*(-83*yij**2 + 15*zij**2) + 
           xij**2*(8*yij**4 - 166*yij**2*zij**2 + 15*zij**4) - 
           18*b**2*(xij**4 + 16*yij**4 - 16*yij**2*zij**2 + zij**4 + 2*xij**2*(-8*yij**2 + zij**2))))/(8.*eta*PI*(xij**2 + yij**2 + zij**2)**6.5),
      (90*b**6*(5*xij**6 - 16*yij**6 + 120*yij**4*zij**2 - 90*yij**2*zij**4 + 5*zij**6 + 15*xij**4*(-6*yij**2 + zij**2) + 
      ...
      (5*b**4*xij*yij*(15*xij**6 - 34*yij**6 + 367*yij**4*zij**2 + 269*yij**2*zij**4 - 132*zij**6 - 2*xij**4*(2*yij**2 + 51*zij**2) + 
           xij**2*(-53*yij**4 + 265*yij**2*zij**2 - 249*zij**4) - 
           54*b**2*(xij**4 - 2*yij**4 + 23*yij**2*zij**2 - 8*zij**4 - xij**2*(yij**2 + 7*zij**2))))/(24.*eta*PI*(xij**2 + yij**2 + zij**2)**6.5),
      (-5*b**4*yij*zij*(-75*xij**6 - 152*yij**6 + 188*yij**4*zij**2 + 265*yij**2*zij**4 - 75*zij**6 + 5*xij**4*(53*yij**2 - 45*zij**2) + 
           xij**2*(188*yij**4 + 530*yij**2*zij**2 - 225*zij**4) + 
           54*b**2*(5*xij**4 + 8*yij**4 - 20*yij**2*zij**2 + 5*zij**4 + 10*xij**2*(-2*yij**2 + zij**2))))/(24.*eta*PI*(xij**2 + yij**2 + zij**2)**6.5)
       ,(270*b**6*(xij**6 + 8*yij**6 - 116*yij**4*zij**2 + 101*yij**2*zij**4 - 6*zij**6 - xij**4*(11*yij**2 + 4*zij**2) + 
            xij**2*(-4*yij**4 + 90*yij**2*zij**2 - 11*zij**4)) - 
         7*b**4*(9*xij**8 + 104*yij**8 - 1364*yij**6*zij**2 - 271*yij**4*zij**4 + 1131*yij**2*zij**6 - 66*zij**8 - 3*xij**6*(38*yij**2 + 13*zij**2) + 
            xij**4*(-151*yij**4 + 903*yij**2*zij**2 - 171*zij**4) + xij**2*(76*yij**6 - 422*yij**4*zij**2 + 2148*yij**2*zij**4 - 189*zij**6)))/
       (168.*eta*PI*(xij**2 + yij**2 + zij**2)**6.5)]])
...
def K3s2s(xij,yij,zij, b,eta):
    return np.array([[(-36*b**6*xij*(8*xij**4 - 40*xij**2*(yij**2 + zij**2) + 15*(yij**2 + zij**2)**2) + 
       ...
       (21.*(xij**2 + yij**2 + zij**2)**5.5),(b**4*xij*(36*b**2*(4*xij**4 + xij**2*(-41*yij**2 + zij**2) + 3*(6*yij**4 + 5*yij**2*zij**2 - zij**4)) - 
     ...
     [-0.015873015873015872*(b**4*yij*(-896*xij**6 + 322*xij**4*(yij**2 + zij**2) + 1127*xij**2*(yij**2 + zij**2)**2 - 91*(yij**2 + zij**2)**3 + 
            324*b**2*(8*xij**4 - 12*xij**2*(yij**2 + zij**2) + (yij**2 + zij**2)**2)))/(xij**2 + yij**2 + zij**2)**5.5,
      (b**4*xij*(-35*(4*xij**6 - 25*xij**2*yij**2*(yij**2 + zij**2) + (17*yij**2 - 2*zij**2)*(yij**2 + zij**2)**2 + xij**4*(-38*yij**2 + 6*zij**2)) + 
     ...
     [-0.015873015873015872*(b**4*zij*(-896*xij**6 + 322*xij**4*(yij**2 + zij**2) + 1127*xij**2*(yij**2 + zij**2)**2 - 91*(yij**2 + zij**2)**3 + 
            324*b**2*(8*xij**4 - 12*xij**2*(yij**2 + zij**2) + (yij**2 + zij**2)**2)))/(xij**2 + yij**2 + zij**2)**5.5,
      (b**4*xij*yij*zij*(220*xij**4 - 324*b**2*(2*xij**2 - yij**2 - zij**2) + 125*xij**2*(yij**2 + zij**2) - 95*(yij**2 + zij**2)**2))/
     ...
     [(b**4*xij*(108*b**2 - 35*(xij**2 + yij**2 + zij**2))*(4*xij**4 + xij**2*(-41*yij**2 + zij**2) + 3*(6*yij**4 + 5*yij**2*zij**2 - zij**4)))/
       (63.*(xij**2 + yij**2 + zij**2)**5.5),(b**4*yij*(108*b**2*
            (18*xij**4 + 4*yij**4 + yij**2*zij**2 - 3*zij**4 + xij**2*(-41*yij**2 + 15*zij**2)) - 
